...
const BLUE = '#131d34'
const BLUE_DARK = '#1d3672'
const BLUE_LIGHT = '#e5faf3'
const BG = '#fafbfc'
const BORDER = '#e1e4ea'
...
const button = { backgroundColor: BLUE, backgroundImage: `linear-gradient(135deg, ${BLUE} 0%, ${BLUE_DARK} 100%)`, color: '#ffffff', padding: '17px 40px', borderRadius: '999px', textDecoration: 'none', fontSize: '16px', fontWeight: '600' as const, display: 'inline-block', letterSpacing: '-0.2px', boxShadow: '0 8px 20px rgba(19,29,52,0.28)', border: '1px solid rgba(255,255,255,0.12)' }
